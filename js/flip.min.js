...
!(function() {
	...
	Array.prototype.fill ||
		...
		Array.from ||
			(Array.from = ((e = Object.prototype.toString),
			(r = Math.pow(2, 53) - 1),
			function(t, e, n) {
				var r = Object(t);
				...
				for (var a, u = f(r.length), l = c(this) ? Object(new this(u)) : new Array(u), s = 0; s < u; )
					(a = r[s]), (l[s] = o ? (void 0 === i ? o(a, s) : o.call(i, a, s)) : a), (s += 1);
				return (l.length = u), l;
			})),
		...
		Object.keys ||
			(Object.keys = ((i = Object.prototype.hasOwnProperty),
						...
						(t.exports = function(t) {
							function n(o) {
								...
								if (((o.spacer.textContent = o.value), o.isInitialValue() || s.visible(o.root))) {
									...
									if (
										(n && ((n.waiting = !1), (n.offset = l()), (n.back = o.value)),
										o.isInitialValue())
									) {
										var r = new h();
										(r.back = o.value),
										...
										!(function t() {
											...
											if (0 !== r.length) {
												r.forEach(function(t) {
													null !== t.offset &&
														(t.progress = (l() - t.offset) / o.style.flipDuration),
														1 <= t.progress && ((t.progress = 1), (t.done = !0)),
								...
								h = (v(p, [
									{
										...
										value: function(t) {
											(this._front.style.transform = 'rotateX(' + t + 'deg)'),
												(this._back.style.transform = 'rotateX(' + (-180 + t) + 'deg)');
										}
									},
									{
										key: 'root',
	...
	(function(t, e, cn) {
		...
		if (t && 'MutationObserver' in t && 'requestAnimationFrame' in t) {
			var n = (function() {
				...
				function i(t, e, n) {
					if (!r[t])
						throw 'Can\'t add extension with type of "' +
							t +
							'", "' +
							t +
							...
							Ne(r);
					if (!/^[-a-z]+$/.test(e))
						throw 'Can\'t add extension with name "' +
							e +
							'", "' +
							e +
				...
				function c(t, e) {
					if (!r[t])
						throw 'Can\'t get extension with type of "' +
							t +
							'", "' +
							t +
							...
							Ne(r);
					if (!r[t][e])
						throw 'Can\'t get extension with name "' +
							e +
							'", "' +
							e +
				...
				for (var o in h)
					if (h.hasOwnProperty(o)) {
						...
						1 === a
							? ((h.mi = a), (h.ms = a))
							: 2628e6 === a ? (h.M = a) : (h[o.charAt(0).toLowerCase()] = a),
							(h[o.toLowerCase()] = a),
							(h[o.toLowerCase() + 's'] = a);
					}
				function u(t) {
				...
				function w() {
					...
					if ('number' != typeof e[0] || 'string' != typeof e[1])
						return u(e[0])
							? y.apply(cn, e)
							: 'number' == typeof e[0] && Array.isArray(e[1]) ? g.apply(cn, e) : null;
				...
				function A(r) {
					...
					return (
						...
						t &&
							t.dataset.layout &&
							(r.align = (t.dataset.layout.match(/left|right|center/) || [])[0] || 'left'),
						{
							appendTo: function(t, e) {
								...
								!r.root ||
									...
									('last' !== n
										...
										: t.childNodes.length &&
											t.childNodes[t.childNodes.length - 1].nodeType === Node.TEXT_NODE
											? t.insertBefore(r.root, t.childNodes[t.childNodes.length - 1])
											: t.appendChild(r.root));
							}
						}
				...
				var C = { Monday: 1, Tuesday: 2, Wednesday: 3, Thursday: 4, Friday: 5, Saturday: 6, Sunday: 0 },
					D = { M: 1, y: 12 },
					N = function(t, e) {
					...
					R = function(t) {
						if (!t.fit) {
							if (!t.root || !(t.root.getAttribute('data-layout') || '').match(/fit/))
								return void (t.fit = !1);
							var e = window.getComputedStyle(t.root, null);
							(t.fit = !0),
								(t.fitInfo = { currentFontSize: parseInt(e.getPropertyValue('font-size'), 10) });
						}
						(t.fitInfo.availableWidth = t.root.parentNode.clientWidth),
							(t.fitInfo.currentWidth = t.root.scrollWidth);
						var n = Math.min(
							Math.max(4, t.fitInfo.availableWidth / t.fitInfo.currentWidth * t.fitInfo.currentFontSize),
							1024
						);
						...
						t
							...
							.forEach(function(t) {
								Array.isArray(r) && e.valueMapping
									? e.update(
											t,
											'indexes' === e.valueMapping ? ('right' === e.align ? r.pop() : r.shift()) : r
										)
									: t.key && r[t.key] !== cn ? e.update(t, r[t.key]) : e.update(t, r);
							}),
						(e.views = t),
						ot(e);
				}
				function G(r, i) {
					...
					t.forEach(function(t, e) {
						...
						n ||
							...
							(r.update = i(n)),
							n.presenter.appendTo(r.root, 'right' === r.align ? 'first' : 'last'));
					}),
						t.forEach(function(t, e) {
								...
								: dt.test(e)
									...
									: yt.test(e)
										? 1 ===
											...
											: i
										: ht.test(n)
											? vt.test(e) ? X(e, K) : X(e, Et)
											: pt.test(n) ? X(e, Q) : gt.test(n) && 'none' !== e ? X(e, J) : e);
					...
					wt = function(t) {
						...
						return (
							e
								...
								.forEach(function(t) {
									mt.test(t)
										? void 0 === i ? (i = Z(t)) : (a = Z(t))
										: / /.test(t)
											? (r = t)
											: /^ease-[a-z-]+$/.test(t) ? (o = t) : /^[a-z]+/.test(t) && (u = se(t));
								}),
							u && (o = i = cn),
							{
								name: n.name,
					...
					kt =
						'undefined' == typeof document
							...
							: function(t) {
									...
									if (a) {
										...
										return (
											u.node ||
												...
												(u.node.style.cssText = 'position:absolute;padding:0;visibility:hidden;'),
									...
									return (
										(l.style.cssText =
											'position:absolute;padding:0;visibility:hidden;margin-top:' + t),
										o.appendChild(l),
				...
				function Ct(t) {
					...
					var a,
						u,
						i = ((u = { velocity: 0, origin: 0, position: 0, destination: 1 }),
						{
							...
							translate: function(r, t, e, i) {
								l(),
									null === e
										? (u.destination = t)
										: ((u.position = t), (u.destination = e), (u.velocity = 0)),
									(u.origin = u.position);
								var o = null;
								!(function t(e) {
				...
				var Tt = function(n, t, e, r) {
						...
						return (
							(function t(e) {
								if ((null === u && (u = e), (l = e - u - a) < o))
									return n(0 <= l ? l / o : 0), (s = requestAnimationFrame(t)), null;
								n(1), i && i();
							})(ke()),
							function() {
					...
					Rt = function(e, t, n) {
						...
						return function(t) {
							e(
								t,
								1 < arguments.length && arguments[1] !== cn ? arguments[1] : null,
								...
								function(t, e) {
									...
									(t.velocity += 2 * (-(r - t.origin) + n) * o),
										(t.position +=
											t.velocity < 0 ? Math.max(t.velocity, -i) : Math.min(t.velocity, i)),
										((t.origin < t.destination && t.position >= t.destination) ||
											(t.origin >= t.destination && t.position <= t.destination)) &&
				...
				function Vt(t, e, n) {
					...
					return r
						? r({
								...
								Canvas: { clear: St, getDevicePixelRatio: Ot, getBackingStoreRatio: It },
				...
				function Zt(t) {
					...
					return (
						(function t(e, n, r) {
							...
							return (
								((c && u.trim().length) || (!c && u.trim().length && !l.length)) &&
									(l.push([
										u.trim()
									]),
									(u = '')),
						...
						return (
							...
							(n = e).repeat
								...
								: 'string' == typeof n.view
									...
									: (i = n).children && i.children.length && (o = Wt(n.root, n.children, r)),
							o)),
				...
				function Kt(i) {
					for (var t = arguments.length, o = Array(1 < t ? t - 1 : 0), e = 1; e < t; e++)
						o[e - 1] = arguments[e];
					return function(t, r) {
						!(function t(e, n) {
							o.length <= e
						...
						for (var r in e)
							e.hasOwnProperty(r) &&
								(n[r] =
									'root' !== r
										? 'children' !== r
											? 'repeat' !== r ? e[r] : null === e[r] ? null : t(e[r])
											: null === e[r] ? null : e[r].map(t)
										: e[r].cloneNode());
					...
					ye = function(t) {
						return de.test(t)
							...
							: ge.test(t)
								...
								: fe.test(t)
									? l(t)
									: ve.test(t) ? Qt(t) : !he.test(t) && !pe.test(t) && me.test(t) ? parseFloat(t) : t;
					},
					we = function(t, e) {
				...
				function Pe(t, e) {
					return (
						(n = t), (r = e.split(':').map(re)), n.setHours(r[0] || 0, r[1] || 0, r[2] || 0, r[3] || 0), n
					);
					var n, r;
				}
				function ze(r, e) {
					...
					if (o.time) {
						...
						var a = o.time - r;
						if (
							(a < 0 && (o.time.setDate(o.time.getDate() + 7), (a = o.time - r)),
					...
					return /januari|februari|march|april|may|june|july|august|september|october|november|december/.test(
						...
						? (function(n, e) {
									...
									function(t, e) {
										return (
											/([\d]+th|\dst|\dnd|first|last)/.test(e) &&
												(t.day = /^[\d]/.test(e) ? parseInt(e, 10) : 'first' === e ? 1 : e),
											/^at/.test(e)
								...
								if (o.time) {
									...
									if (
										(a < 0 &&
											((u = a), o.time.setFullYear(o.time.getFullYear() + 1), (a = o.time - n)),
						...
						: /month/.test(e)
							...
							: /(?:mon|tues|wednes|thurs|fri|satur|sun)day/.test(e)
								...
								: /day at/.test(e) || /^at /.test(e)
									? ((n = t),
										(r = e.match(/([\d]+(?::[\d]+)?(?::[\d]+)?)|(wait\s[\d]+\s[a-z]+)/g).reduce(function(
											t,
											e
										) {
											return (
										...
										r)
									: /hours|hour|minutes|minute|seconds|second/.test(e) ? Je(t, e) : null;
					var n, r, i;
				}
				function qe(t, e) {
					if (!0 === t)
						...
						if ((n && !V(n) && ((r = n), (n = cn)), !n || !Te(n))) {
							r &&
								...
								!r &&
									...
									})(n, Xe, it({}, Ie.options(), { constants: it({}, He), presets: it({}, $e) }))),
								n &&
									((r = r || {}).view ||
										(r.view = (function r(t) {
					...
					tn = {
						...
						number: function() {
							...
							return function(t, e) {
								e(
									(t < 0 ? '-' : '') +
										parseFloat(Math.abs(t)).toFixed(n).replace(/./g, function(t, e, n) {
						...
						spring: function(n, r, i) {
							...
							return function(t, e) {
								(t = parseFloat(t)),
									null !== o
										? a ? a.update(e, t) : (a = Ct('spring', n, r, i)).update(e, o, t)
										: e((o = t));
							};
						},
						delay: function() {
					...
					DOM: {
						...
						parse: function(t) {
							var e,
								...
								r = void 0,
								i = [];
							for (r = (e = t.querySelectorAll('.tick:not([data-state])')).length; r--; )
								(n = e[r]), i.push(Ze(n));
							return i;
						},
						find: Te
						...
						down: function() {
												...
												qe(n.server, function(e) {
													...
													(i.timer = Ue(
														function() {
															...
															if (r - t <= 0)
																return (
																	(i.value = new Array(n.format.length).fill(0)),
																	i.onupdate(i.value),
																	i.timer.stop(),
																	void i.onended()
																);
							...
							return (
								...
								function(e, t) {
									...
									var r = (n = we({ units: 'seconds', target: 0, amount: 1e3, interval: 1e3 }, n))
											.target,
										i = e,
						...
						schedule: function(i, t) {
							...
							var a = (o = we(it({}, Ke, { timezone: null }), o)).timezone
									? (function(t) {
											...
											return (
												('-' === n.shift() ? -1 : 1) *
													(36e5 * parseInt(n[0], 10) + 6e4 * parseInt(n[1], 10)) +
												e
											);
										})(o.timezone)
									: null,
									...
									(u.timer = Ue(
										function() {
											...
											if (
												...
												(s = (function(e, t) {
													for (
														var n = t.split(',').map(be).map(function(t) {
																return je(e, t);
															}),
															r = null,
															i = 0;
												...
												return (
													...
													u.nextScheduledDate &&
														(u.previouslyScheduledDate = O(u.nextScheduledDate)),
													(u.nextScheduledDate = null === s ? null : O(s)),
													void u.onwait(
														u.previouslyScheduledDate ? O(u.previouslyScheduledDate) : null
													)
												);
											(u.nextScheduledDate = O(s)),
												null === l && u.onresume(O(s)),
												(null === l || (l !== cn && ((e = s), l.getTime() !== e.getTime()))) &&
